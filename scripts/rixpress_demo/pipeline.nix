...
"
  ...
  page = defaultPkgs.stdenv.mkDerivation {
    ...
    buildPhase = ''
      ...
      substituteInPlace my_doc/page.qmd --replace-fail 'rxp_read("mtcars_tail")' 'rxp_read("${mtcars_tail}")'
      substituteInPlace my_doc/page.qmd --replace-fail 'rxp_read("mtcars_mpg")' 'rxp_read("${mtcars_mpg}")'
      substituteInPlace my_doc/page.qmd --replace-fail 'rxp_read("mtcars_tail_py")' 'rxp_read("${mtcars_tail_py}")'
