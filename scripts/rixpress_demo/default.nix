# This file was generated by the {rix} R package v0.16.1 on 2025-05-05
# with following call:
# >rix(date = "2025-04-14",
#  > r_pkgs = c("chronicler",
#  > "dplyr",
  ...
  rpkgs = builtins.attrValues {
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "HEAD";
        sha256 = "sha256-Ti4HHrXDVdTyGgDPz6SRWukKs2TC64octUM/sZ9KGSw=";
      };
    ...
    rixpress = (pkgs.rPackages.buildRPackage {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "HEAD";
        sha256 = "sha256-jyV9s7+pQwFwCUR6Lnn+x9MxuV0Lo86Adcip7h1I9mE=";
      };
      propagatedBuildInputs = builtins.attrValues {
        inherit (pkgs.rPackages) 
          igraph
